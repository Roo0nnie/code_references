...
public class RomanCalculator implements ActionListener{
	...
	public void darkmode() {
		...
		RomanCalculator() {
	        ...
	        hello.setForeground(Color.white); //set the color of the "Standard calculator" to white
    		...
    		panel = new JPanel();
    		panel.setBounds(10, 150, 318, 300); 
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()== buttonCE) {
			...
			while(num1 != 0) {
				if(num1 >= 1000) {
					text.setText(text.getText().concat("M"));
					num1 -= 1000;
				}else if(num1 >= 900) {
					text.setText(text.getText().concat("CM"));
					num1 -= 900;
				}else if(num1 >= 500) {
					text.setText(text.getText().concat("D"));
					num1 -= 500;	
				}else if(num1 >= 400) {
					text.setText(text.getText().concat("CD"));
					num1 -= 400;	
				}else if(num1 >= 100) {
					text.setText(text.getText().concat("C"));
					num1 -= 100;	
				}else if(num1 >= 90) {
					text.setText(text.getText().concat("XC"));
					num1 -= 90;	
				}else if(num1 >= 50) {
					text.setText(text.getText().concat("L"));
					num1 -= 50;	
				}else if(num1 >= 40) {
					text.setText(text.getText().concat("XL"));
					num1 -= 40;	
				}else if(num1 >= 10) {
					text.setText(text.getText().concat("X"));
					num1 -= 10;	
				}else if(num1 >= 9) {
					text.setText(text.getText().concat("IX"));
					num1 -= 9;	
				}else if(num1 >= 5) {
					text.setText(text.getText().concat("V"));
					num1 -= 5;	
				}else if(num1 >= 4) {
					text.setText(text.getText().concat("IV"));
					num1 -= 4;	
				} else {
					text.setText(text.getText().concat("I"));
					num1 -= 1;				
				}
			}
		}		
